...
public class AllBooksAdapter extends RecyclerView.Adapter<AllBooksAdapter.ViewHolder> {
    ...
    public AllBooksAdapter(ArrayList<BookData> myDataset) {
        mDataset = myDataset;
    }


    @Override
    public AllBooksAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v) {
                    ...
                    Intent i=new Intent(v.getContext(),book_detail.class );
